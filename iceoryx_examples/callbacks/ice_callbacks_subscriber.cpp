...
int main()
{
    ...
    listener.attachEvent(subscriberLeft, iox::popo::SubscriberState::HAS_DATA, onSampleReceivedCallback)
        .or_else([](auto) {
    ...
    listener.attachEvent(subscriberRight, iox::popo::SubscriberState::HAS_DATA, onSampleReceivedCallback)
        .or_else([](auto) {
    ...
    listener.detachEvent(subscriberLeft, iox::popo::SubscriberState::HAS_DATA);
    listener.detachEvent(subscriberRight, iox::popo::SubscriberState::HAS_DATA);
