...
|[icecallback_in_c](./icecallback_in_c/)                 | The `WaitSet` is our technique for providing the user the ability to write callbacks for certain events like receiving a sample. |
...
|[icedelivery_in_c](./icedelivery_in_c/)                 | Shows the same use case as the ice delivery example but with the iceoryx C API  |
