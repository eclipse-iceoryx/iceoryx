...
int main()
{
    ...
    {
        subscriberVector[i].enableEvent(waitset, FIRST_GROUP_ID, nullptr, iox::popo::SubscriberEvent::HAS_SAMPLES);
    }
    ...
    {
        subscriberVector[i].enableEvent(waitset, SECOND_GROUP_ID, nullptr, iox::popo::SubscriberEvent::HAS_SAMPLES);
    }
