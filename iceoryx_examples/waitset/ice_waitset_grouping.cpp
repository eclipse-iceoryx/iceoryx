...
int main()
{
    ...
    {
        waitset.attachEvent(subscriberVector[i], FIRST_GROUP_ID, nullptr, iox::popo::SubscriberEvent::HAS_SAMPLES);
    }
    ...
    {
        waitset.attachEvent(subscriberVector[i], SECOND_GROUP_ID, nullptr, iox::popo::SubscriberEvent::HAS_SAMPLES);
    }
