...
TEST_F(CmdLineParser_test, LogLevelOptionsLeadToCorrectLogLevel)
{
    ...
    constexpr uint8_t NUMBER_OF_ARGS{ 3U };
    LogLevel loglevelArray[] = { LogLevel::OFF,  LogLevel::FATAL, LogLevel::ERROR, LogLevel::WARN,
...
TEST_F(CmdLineParser_test, CompatibilityLevelOptionsLeadToCorrectCompatibilityLevel)
{
    ...
    constexpr uint8_t NUMBER_OF_ARGS{ 3U };
    CompatibilityCheckLevel loglevelArray[] = {
        CompatibilityCheckLevel::OFF,   CompatibilityCheckLevel::MAJOR,     CompatibilityCheckLevel::MINOR,
        CompatibilityCheckLevel::PATCH, CompatibilityCheckLevel::COMMIT_ID, CompatibilityCheckLevel::BUILD_DATE
    };
    char* args[NUMBER_OF_ARGS];
    char appName[] = "./foo";
