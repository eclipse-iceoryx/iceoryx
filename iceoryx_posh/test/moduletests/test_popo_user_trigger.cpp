...
{
    m_sut.enableTriggerEvent(m_waitSet);
    m_sut.trigger();
    EXPECT_TRUE(m_sut.hasTriggered());
}
...
TEST_F(UserTrigger_test, UserTriggerGoesOutOfScopeCleansupAtWaitSet)
{
    {
        UserTrigger sut;
        sut.enableTriggerEvent(m_waitSet);
    }
...
{
    {
        ...
        sut.enableTriggerEvent(m_waitSet);
        sut.enableTriggerEvent(m_waitSet2);
    }
...
TEST_F(UserTrigger_test, TriggersWaitSet)
{
    ...
    sut.enableTriggerEvent(m_waitSet, 4412);
    sut.trigger();
...
{
    UserTrigger sut;
    sut.enableTriggerEvent(m_waitSet, 123, UserTrigger_test::callback);
    sut.trigger();
...
{
    UserTrigger sut;
    sut.enableTriggerEvent(m_waitSet, UserTrigger_test::callback);
    sut.trigger();
