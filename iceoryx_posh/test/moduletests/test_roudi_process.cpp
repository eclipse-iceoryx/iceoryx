...
class IpcInterfaceUser_Mock : public iox::roudi::Process
{
  public:
    IpcInterfaceUser_Mock()
        : iox::roudi::Process(
            "TestProcess", DEFAULT_UNIQUE_ROUDI_ID, 200, PosixUser("foo"), HeartbeatPool::Index::INVALID, 255)
    {
    }
...
TEST_F(Process_test, getPid)
{
    ...
    Process roudiproc(processname, DEFAULT_UNIQUE_ROUDI_ID, pid, user, heartbeatPoolIndex, sessionId);
