...
{
    return cxx::align(sizeof(mepoo::SegmentManager<>), mepoo::MemPool::CHUNK_MEMORY_ALIGNMENT)
...
{
    return algorithm::max(alignof(mepoo::SegmentManager<>), mepoo::MemPool::CHUNK_MEMORY_ALIGNMENT);
}
