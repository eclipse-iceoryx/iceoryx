...
ReceiverHandler<MaxReceivers, LockingPolicy>::AppContext::AppContext(ReceiverHandler_t& f_receiverHandler)
    : m_receiverHandler(f_receiverHandler)
{
}

template <uint32_t MaxReceivers, typename LockingPolicy>
bool ReceiverHandler<MaxReceivers, LockingPolicy>::AppContext::hasLastChunk()
{
    return m_receiverHandler.hasLastChunk();
}

template <uint32_t MaxReceivers, typename LockingPolicy>
void ReceiverHandler<MaxReceivers, LockingPolicy>::AppContext::deliverChunk(const mepoo::SharedChunk f_chunk)
{
    m_receiverHandler.deliverChunk(f_chunk);
}

template <uint32_t MaxReceivers, typename LockingPolicy>
void ReceiverHandler<MaxReceivers, LockingPolicy>::AppContext::updateLastChunk(const mepoo::SharedChunk f_chunk)
{
...
template <uint32_t MaxReceivers, typename LockingPolicy>
bool ReceiverHandler<MaxReceivers, LockingPolicy>::AppContext::hasReceivers()
{
    return m_receiverHandler.hasReceivers();
}

template <uint32_t MaxReceivers, typename LockingPolicy>
void ReceiverHandler<MaxReceivers, LockingPolicy>::AppContext::enableDoDeliverOnSubscription()
{
...
template <uint32_t MaxReceivers, typename LockingPolicy>
ReceiverHandler<MaxReceivers, LockingPolicy>::RouDiContext::RouDiContext(ReceiverHandler_t& f_receiverHandler)
    : m_receiverHandler(f_receiverHandler)
{
}

template <uint32_t MaxReceivers, typename LockingPolicy>
bool ReceiverHandler<MaxReceivers, LockingPolicy>::RouDiContext::addNewReceiver(
...
template <uint32_t MaxReceivers, typename LockingPolicy>
void ReceiverHandler<MaxReceivers, LockingPolicy>::RouDiContext::removeReceiver(
    ReceiverPortType::MemberType_t* const f_receiver)
{
...
template <uint32_t MaxReceivers, typename LockingPolicy>
void ReceiverHandler<MaxReceivers, LockingPolicy>::RouDiContext::removeAll()
{
    m_receiverHandler.removeAll();
}

template <uint32_t MaxReceivers, typename LockingPolicy>
void ReceiverHandler<MaxReceivers, LockingPolicy>::deliverChunk(const mepoo::SharedChunk f_chunk)
{
...
template <uint32_t MaxReceivers, typename LockingPolicy>
void ReceiverHandler<MaxReceivers, LockingPolicy>::updateLastChunk(const mepoo::SharedChunk f_chunk)
{
    lockGuard_t lock(*this);
...
template <uint32_t MaxReceivers, typename LockingPolicy>
bool ReceiverHandler<MaxReceivers, LockingPolicy>::hasLastChunk()
{
    lockGuard_t lock(*this);
...
template <uint32_t MaxReceivers, typename LockingPolicy>
bool ReceiverHandler<MaxReceivers, LockingPolicy>::hasReceivers()
{
    lockGuard_t lock(*this);
...
template <uint32_t MaxReceivers, typename LockingPolicy>
bool ReceiverHandler<MaxReceivers, LockingPolicy>::addNewReceiver(ReceiverPortType::MemberType_t* const f_receiver)
{
    lockGuard_t lock(*this);
...
template <uint32_t MaxReceivers, typename LockingPolicy>
void ReceiverHandler<MaxReceivers, LockingPolicy>::removeReceiver(ReceiverPortType::MemberType_t* const f_receiver)
{
    lockGuard_t lock(*this);
...
template <uint32_t MaxReceivers, typename LockingPolicy>
void ReceiverHandler<MaxReceivers, LockingPolicy>::removeAll()
{
    lockGuard_t lock(*this);
...
template <uint32_t MaxReceivers, typename LockingPolicy>
void ReceiverHandler<MaxReceivers, LockingPolicy>::enableDoDeliverOnSubscription()
{
    m_doDeliverOnSubscription.store(true, std::memory_order_relaxed);
}

template <uint32_t MaxReceivers, typename LockingPolicy>
bool ReceiverHandler<MaxReceivers, LockingPolicy>::doesDeliverOnSubscribe() const
{
