...
class ChunkQueuePopper
{
  public:
    ...
    [[gnu::deprecated]] cxx::expected<ChunkQueueError> attachSemaphore(mepoo::SharedPointer<posix::Semaphore>) noexcept;
    ...
    [[gnu::deprecated]] bool isSemaphoreAttached() noexcept;
