...
cxx::expected<Request<const Req>, ServerRequestResult> ServerImpl<Req, Res, BaseServerT>::take() noexcept
{
    ...
    auto request =
        cxx::unique_ptr<const Req, void(const Req*)>(static_cast<const Req*>(payload), [this](const Req* payload) {
...
ServerImpl<Req, Res, BaseServerT>::loanUninitialized(const Request<const Req>& request) noexcept
{
    ...
    auto response = cxx::unique_ptr<Res, void(Res*)>(static_cast<Res*>(payload), [this](Res* payload) {
