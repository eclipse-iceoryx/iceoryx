...
TYPED_TEST(stringTyped_test, CompareEqStringAndCharArrayOrStdStringWithDifferentCapaResultsInZero)
{
...
TEST(stringTyped_test, TypeInfo_StringTypeTranslatesCorrectly)
{
...
TEST(stringTyped_test, TypeInfo_uint32_tTranslatesCorrectly)
{
...
TEST(stringTyped_test, TypeInfo_uint64_tTranslatesCorrectly)
{
