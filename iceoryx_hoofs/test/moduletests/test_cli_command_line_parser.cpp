...
TEST_F(CommandLineParser_test, FailSyntaxWhenShortOptionNameHasMoreThenOneLetter_MultiArgument)
{
    ...
    FailureTest({ "-invalid-option", "someValue", "--bla", "blaValue123123", "--set", "setValueXXX" },
                optionsToRegister);
    // middle
    FailureTest({ "--bla", "blaValue123123", "-invalid-option", "--set", "setValueXXX" }, optionsToRegister);
    FailureTest({ "--bla", "blaValue123123", "-invalid-option", "someValue", "--set", "setValueXXX" },
                optionsToRegister);
    // end
    FailureTest({ "--bla", "blaValue123123", "--set", "setValueXXX", "-invalid-option" }, optionsToRegister);
    FailureTest({ "--bla", "blaValue123123", "--set", "setValueXXX", "-invalid-option", "someValue" },
                optionsToRegister);
}
...
TEST_F(CommandLineParser_test, ReadOptionSuccessfully_MultiArgument)
{
    ...
    auto option =
        SuccessTest({ "--moon", "bright", "--conway", "gameOfLife", "--tungsten", "heavy" }, optionsToRegister);
...
TEST_F(CommandLineParser_test, ReadOptionSuccessfully_Offset)
{
    ...
    auto option = SuccessTest(
        { "whatever", "bright", "-t", "heavy", "-c", "gameOfLife" }, optionsToRegister, {}, {}, ARGC_OFFSET);
...
TEST_F(CommandLineParser_test, ReadRequiredValueSuccessfully_SingleArgument)
{
    ...
    auto option =
        SuccessTest({ "--fuubar", "ohFuBa" }, optionsToRegister, switchesToRegister, requiredValuesToRegister);
