...
#include "iceoryx_hoofs/error_reporting/api2.hpp"
...
class ErrorReportingAPI2_test : public Test
{
  public:
    void SetUp() override
    {
...
TEST_F(ErrorReportingAPI2_test, unconditionalPanic)
{
    auto f = []() { IOX_PANIC(); };
...
TEST_F(ErrorReportingAPI2_test, unconditionalPanicWithMessage)
{
...
TEST_F(ErrorReportingAPI2_test, reportNonFatal)
{
    auto f = []() {
...
#if 0
TEST_F(ErrorReportingAPI2_test, reportFatal)
{
    auto f = []() {
        auto e = IOX_ERROR(MyCode::Unknown);
        IOX_REPORT_FATAL(e);
...
TEST_F(ErrorReportingAPI2_test, reportConditionallyTrue)
{
    auto f = []() {
        auto e = IOX_ERROR(MyCode::Unknown);
...
TEST_F(ErrorReportingAPI2_test, reportConditionallyFalse)
{
    auto f = []() {
        auto e = IOX_ERROR(MyCode::Unknown);
...
TEST_F(ErrorReportingAPI2_test, assertTrue)
{
    auto f = []() {
        auto e = IOX_ERROR(MyCode::Unknown);
        IOX_ASSERT(true, e);
...
TEST_F(ErrorReportingAPI2_test, assertFalse)
{
    auto f = []() {
        auto e = IOX_ERROR(MyCode::Unknown);
        IOX_ASSERT(false, e);
...
TEST_F(ErrorReportingAPI2_test, checkPreconditionTrue)
{
...
TEST_F(ErrorReportingAPI2_test, checkPreconditionFalse)
{
    auto f = [](int x) { IOX_PRECONDITION(x > 0); };
...
TEST_F(ErrorReportingAPI2_test, checkPreconditionWithMessage)
{
...
TEST_F(ErrorReportingAPI2_test, checkAssumptionTrue)
{
...
TEST_F(ErrorReportingAPI2_test, checkAssumptionFalse)
{
    auto f = [](int x) { IOX_ASSUME(x > 0); };
...
TEST_F(ErrorReportingAPI2_test, checkAssumptionWithMessage)
{
...
TEST_F(ErrorReportingAPI2_test, reportExpectedAsError)
{
