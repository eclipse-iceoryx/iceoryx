...
TEST(NewType, ComparableDoesCompile)
{
    ...
    using SutType = Sut<NewType<int, newtype::ConstructByValueCopy, newtype::Comparable>>;
    SutType a(123);
    SutType b(456);
    EXPECT_TRUE(a != b);
    EXPECT_FALSE(a == b);
...
TEST(NewType, SortableDoesCompile)
{
    ...
    using SutType = Sut<NewType<int, newtype::ConstructByValueCopy, newtype::Sortable>>;
    SutType a(456);
    SutType b(789);
    EXPECT_TRUE(a < b);
    EXPECT_TRUE(a <= b);
...
TEST(NewType, DefaultConstructableDoesCompile)
{
    ...
    Sut<NewType<int, newtype::DefaultConstructable>> a;
}

TEST(NewType, CopyConstructableDoesCompile)
{
    ::testing::Test::RecordProperty("TEST_ID", "177491d2-a940-4584-a362-f973f93b0445");
    using SutType = Sut<NewType<int, newtype::ConstructByValueCopy, newtype::CopyConstructable, newtype::Comparable>>;
    SutType a(91);
    SutType b(92);
...
TEST(NewType, CopyConstructableComplexTypeDoesCompile)
{
    ...
    using SutType =
        Sut<NewType<ComplexType, newtype::ConstructByValueCopy, newtype::CopyConstructable, newtype::Comparable>>;
    SutType a(91);
    SutType b(92);
    // NOLINTNEXTLINE(performance-unnecessary-copy-initialization) copy constructor shall be tested
    SutType c(a);
...
TEST(NewType, CopyAssignableDoesCompile)
{
    ...
    using SutType = Sut<NewType<int, newtype::ConstructByValueCopy, newtype::CopyAssignable, newtype::Comparable>>;
    SutType a(491);
    SutType b(492);
    SutType c(491);
...
TEST(NewType, CopyAssignableComplexTypeDoesCompile)
{
    ...
    using SutType =
        Sut<NewType<ComplexType, newtype::ConstructByValueCopy, newtype::CopyAssignable, newtype::Comparable>>;
    SutType a(491);
    SutType b(492);
    SutType c(491);
...
TEST(NewType, MoveConstructableDoesCompile)
{
    ...
    using SutType = Sut<NewType<int, newtype::ConstructByValueCopy, newtype::MoveConstructable, newtype::Comparable>>;
    SutType b(92);
    SutType c(92);
...
TEST(NewType, MoveConstructableComplexTypeDoesCompile)
{
    ...
    using SutType =
        Sut<NewType<ComplexType, newtype::ConstructByValueCopy, newtype::MoveConstructable, newtype::Comparable>>;
    SutType b(92);
    SutType c(92);
    SutType d(std::move(c));
    EXPECT_TRUE(b == d);
...
TEST(NewType, MoveAssignableDoesCompile)
{
    ...
    using SutType = Sut<NewType<int, newtype::ConstructByValueCopy, newtype::MoveAssignable, newtype::Comparable>>;
    SutType b(912);
    SutType c(912);
    SutType d(123);
    d = std::move(c);
...
TEST(NewType, MoveAssignableComplexTypeDoesCompile)
{
    ...
    using SutType =
        Sut<NewType<ComplexType, newtype::ConstructByValueCopy, newtype::MoveAssignable, newtype::Comparable>>;
    SutType b(912);
    SutType c(912);
    SutType d(123);
    d = std::move(c);
...
TEST(NewType, ConversionDoesCompile)
{
    ...
    using SutType = Sut<NewType<int, newtype::ConstructByValueCopy, newtype::Convertable>>;
    SutType a(911);
...
TEST(NewType, AssignByValueCopyDoesCompile)
{
    ...
    using SutType = Sut<NewType<int, newtype::AssignByValueCopy, newtype::ConstructByValueCopy, newtype::Comparable>>;
    SutType a(8791);
    SutType b(651);
...
TEST(NewType, AssignByValueCopyComplexTypeDoesCompile)
{
    ...
    using SutType =
        Sut<NewType<ComplexType, newtype::AssignByValueCopy, newtype::ConstructByValueCopy, newtype::Comparable>>;
    SutType a(8791);
    SutType b(651);
...
TEST(NewType, AssignByValueMoveDoesCompile)
{
    ...
    using SutType = Sut<NewType<int, newtype::AssignByValueMove, newtype::ConstructByValueCopy, newtype::Comparable>>;
    SutType a(8791);
    SutType b(651);
...
TEST(NewType, AssignByValueMoveComplexTypeDoesCompile)
{
    ...
    using SutType =
        Sut<NewType<ComplexType, newtype::AssignByValueMove, newtype::ConstructByValueCopy, newtype::Comparable>>;
    SutType a(8791);
    SutType b(651);
