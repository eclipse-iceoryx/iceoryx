...
TEST_F(convert_test, stringIsNumber_INTEGERWithSign)
{
    ...
    EXPECT_THAT(iox::convert::stringIsNumber("-521", NumberType::INTEGER), Eq(true));
}
...
TEST_F(convert_test, stringIsNumber_NumberWithLetters)
{
    ...
    EXPECT_THAT(iox::convert::stringIsNumber("+123a.123", NumberType::FLOAT), Eq(false));
}
