...
namespace err
{
/// @brief Defines the dynamic error handling interface (i.e. changable at runtime).
...
class ErrorHandlerInterface
{
  public:
    ...
    /// @note some of the logic that is always supposed to happen is factored out at call-site
