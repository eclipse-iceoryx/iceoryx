...
Macro(detect_gtest_package)
    if(NOT GTest_FOUND AND NOT gtest_vendor_FOUND)
        ...
        if(NOT GTest_FOUND)
            ...
            set(IOX_GTEST_LIBS ${GTEST_LIBRARIES} ${GMOCK_LIBRARIES})
            set(IOX_GTEST_INCLUDE_DIRS ${GTEST_FROM_SOURCE_INCLUDE_DIRS} ${GMOCK_FROM_SOURCE_INCLUDE_DIRS})
            set(IOX_EXPORT_GTEST_LIBS ADDITIONAL_EXPORT_TARGETS ${IOX_GTEST_LIBS})
            set(IOX_GTEST_GMOCK_INCLUDE PUBLIC_INCLUDES ${GTEST_INCLUDE_DIRS} ${GMOCK_INCLUDE_DIRS})
