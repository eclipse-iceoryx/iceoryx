...
#define ICEORYX_ERRORS(error) \
    ...
    error(POSH__RUNTIME_SENDERPORT_NOT_UNIQUE) \
    error(POSH__RUNTIME_ROUDI_SENDERLIST_FULL) \
    error(POSH__RUNTIME_SENDERPORT_CREATION_UNDEFINED_BEHAVIOR) \
    error(POSH__RUNTIME_ROUDI_CONDITION_VARIABLE_LIST_FULL) \
    error(POSH__RUNTIME_NO_VALID_CONDITION_VARIABLE_RECEIVED) \
    error(POSH__RUNTIME_CONDITION_VARIABLE_CREATION_UNDEFINED_BEHAVIOR) \
    error(POSH__RUNTIME_WRONG_MESSAGE_QUEUE_RESPONSE) \
    ...
    error(PORT_POOL__SENDERLIST_OVERFLOW) \
    error(PORT_POOL__RECEIVERLIST_OVERFLOW) \
