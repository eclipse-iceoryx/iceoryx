...
#define ICEORYX_ERRORS(error) \
    ...
    error(ROUDI_COMPONENTS__COULD_NOT_ACQUIRE_FILE_LOCK) \
    error(ROUDI_COMPONENTS__ROUDI_STILL_RUNNING) \
    ...
    error(ROUDI__ICEORYX_ROUDI_MEMORY_MANAGER_FAILED_TO_ADD_PORTPOOL_MEMORY_BLOCK) \
    error(ROUDI__ICEORYX_ROUDI_MEMORY_MANAGER_FAILED_TO_ADD_MANAGEMENT_MEMORY_BLOCK) \
