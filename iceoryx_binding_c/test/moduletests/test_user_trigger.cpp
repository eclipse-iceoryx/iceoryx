...
{
    iox_user_trigger_enable_trigger_event(m_sut, &m_waitSet, 0, NULL);
    iox_user_trigger_trigger(m_sut);
    EXPECT_TRUE(iox_user_trigger_has_triggered(m_sut));
}
...
{
    iox_user_trigger_enable_trigger_event(m_sut, &m_waitSet, 88191, NULL);
    iox_user_trigger_trigger(m_sut);
...
{
    iox_user_trigger_enable_trigger_event(m_sut, &m_waitSet, 0, iox_user_trigger_test::triggerCallback);
    iox_user_trigger_trigger(m_sut);
...
TEST_F(iox_user_trigger_test, attachingToAnotherWaitSetCleansupFirstWaitset)
{
    ...
    iox_user_trigger_enable_trigger_event(m_sut, &m_waitSet2, 0, NULL);
...
TEST_F(iox_user_trigger_test, disable_trigger_eventingItFromWaitsetCleansup)
{
    ...
    iox_user_trigger_disable_trigger_event(m_sut);
