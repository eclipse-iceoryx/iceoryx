...
{
    EXPECT_THAT(sizeof(WaitSet<WaitSetPolicy::DEFAULT>), Eq(sizeof(iox_ws_storage_t)));
    EXPECT_THAT(alignof(WaitSet<WaitSetPolicy::DEFAULT>), Le(alignof(iox_ws_storage_t)));
}
