...
#ifndef IOX_eth_eth_DATA_READER_HPP
#define IOX_eth_eth_DATA_READER_HPP
...
class DataReader
{
  public:
    ///
    /// @brief connect Connect the DataReader to the underlying eth network.
    ///
    ...
    ///
    /// @brief take Take the next available sample from the eth data space.
    ...
    ///
    /// @brief take Take up to a maximum number of samples from the eth data space.
...
#endif // IOX_eth_eth_DATA_READER_HPP
