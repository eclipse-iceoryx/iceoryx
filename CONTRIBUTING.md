...
5. Consider using [geoffrey](https://github.com/elBoberido/geoffrey#geoffrey---syncs-source-code-to-markdown-code-blocks) for syncing code in code blocks with the respective source files
6. Add integration test for example
7. [Record an asciicast](./tools/website/how-to-record-asciicast.md) and embed image link
